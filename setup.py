...
setup(
    ...
    url='https://github.com/powersj/ubuntu-distro-info',
    download_url=(
        'https://github.com/powersj/ubuntu-distro-info/tarball/master'
    ),
    ...
    entry_points={
        'console_scripts':
            ['ubuntu-distro-info=ubuntu_distro_info.__main__:launch']
    },
    zip_safe=True
)
